...
CREATE TABLE `catégorie` (
  `CatégorieID` int NOT NULL AUTO_INCREMENT,
  `CatName` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`CatégorieID`),
...
INSERT INTO `catégorie` VALUES (1,'Action'),(2,'Aventure'),(3,'Comédie'),(4,'Horreur'),(5,'Drama');
...
-- Dump completed on 2020-04-20 10:30:29
